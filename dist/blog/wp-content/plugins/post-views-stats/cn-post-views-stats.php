...
Description: This plugins will track each post/page views by visitor. You will be able to see the post view count in "Posts" &ndash;&gt; "All posts" page with a "View count" column, also you can use the widget to display the most popular post in the sidebar ares.
Version: 1.3
Author: cybernetikz
