...
//    else if(isset($legacyadmin['standard_body']) && trim($legacyadmin['standard_body']) != ""){ $bodyfont = "".$legacyadmin['standard_body']."";}
//    if(isset($legacyadmin['google_nav']) && trim($legacyadmin['google_nav']) != ""){ $menufont = "'".$legacyadmin['google_nav']."', sans-serif"; }
//    else if(isset($legacyadmin['standard_nav']) && trim($legacyadmin['standard_nav']) != ""){ $menufont = "".$legacyadmin['standard_nav']."";}
//    if(isset($legacyadmin['google_headings']) && trim($legacyadmin['google_headings']) != ""){ $headingfont = "'".$legacyadmin['google_headings']."', sans-serif"; }
//    else if(isset($legacyadmin['standard_headings']) && trim($legacyadmin['standard_headings']) != ""){ $headingfont = "".$legacyadmin['standard_headings']."";}
