...
function legacy_custom_login() {
    ...
    $url = plugins_url('/', __FILE__) . '../' . $legacy_css_ver . '/legacy-login.css';
    ...
    echo legacy_link_color(".login #backtoblog a, .login #nav a, .login a", "login-link-color") . "\n";
    ...
    /*
      ...
      echo '.login{color: '.$legacyadmin['login-link-color']['regular'].'}';
      ...
      -moz-box-shadow: none;
      -o-shadow: none;
      border-color: " . $legacyadmin['separator-color'] . "
      }";
...
add_filter('login_headertitle', 'legacy_loginlogo_title');
