...
/*ADDED in Legacy Admin - END*/
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Legacy Admin', 'redux-framework-legacy-demo' ),
        'page_title'           => __( 'Legacy Admin', 'redux-framework-legacy-demo' ),
...
/*
    $tabs = array(
        array(
            'id'      => 'redux-help-tab-1',
            'title'   => __( 'Theme Information 1', 'redux-framework-legacy-demo' ),
            'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'redux-framework-legacy-demo' )
        ),
        array(
            'id'      => 'redux-help-tab-2',
            'title'   => __( 'Theme Information 2', 'redux-framework-legacy-demo' ),
            'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'redux-framework-legacy-demo' )
        )
    );
    ...
    $content = __( '<p>This is the sidebar content, HTML is allowed.</p>', 'redux-framework-legacy-demo' );
...
*/
    ...
    // -> START Basic Fields
            ...
            $more_settings_msg = 'You have chosen an inbuilt theme. One or more setting options in this section are applicable for custom theme only.';
                ...
                foreach($legacy_color_list as $colorid => $colorname){
                    $legacy_color_thumbs[$colorid]['title'] = $colorname;
    ...
    function dynamic_section_delete_legacy_conflict( $sections ) {
        //$sections = array();
        $sections[] = array(
            'title'  => __( 'Section via hook', 'redux-framework-legacy-demo' ),
            'desc'   => __( '<p class="description">This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.</p>', 'redux-framework-legacy-demo' ),
