...
echo " \n/* -- Page BG -- */\n";
echo legacy_css_background("html, #wp-content-editor-tools, #ws_menu_editor .ws_editbox", "page-bg", "1.0") . "\n";
...
echo " \n/* -- link color -- */\n";
echo legacy_link_color("a, .no-plugin-results a", "link-color") . "\n";
...
//echo ".row-actions span a:hover {color: ".legacy_colorcode($legacyadmin['button-text-color'],"1.0","!important")."}";
